    ...
    public class TricycleMotorcycle : ITypeScan
    {
        ...
        public int[] GetMaxMinForYAndX(string indexPhoto)
        {
            ...
            switch (indexPhoto)
            {
                ...
                //case "10": maxMinForYAndX = new int[] { 315, 875, 480, 995 }; break;
        ...
        public async Task SetDamage(PhotoInspection photoInspection, string typrCar, string pathScan)
        {
            if (photoInspection.Damages != null)
            {
                foreach (var damage in photoInspection.Damages)
                {
                    ...
                    if (photoInspection.IndexPhoto == 4 || photoInspection.IndexPhoto == 5 || photoInspection.IndexPhoto == 6 || photoInspection.IndexPhoto == 7)
                    {
                        g.DrawImage(img2, x, y);
                    }
                    else if (photoInspection.IndexPhoto == 8 || photoInspection.IndexPhoto == 9 || photoInspection.IndexPhoto == 10 || photoInspection.IndexPhoto == 11 || photoInspection.IndexPhoto == 12)
                    {
